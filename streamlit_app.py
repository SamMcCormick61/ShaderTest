...
# Embed the interactive fractal demo using Three.js
st.header("Interactive Fractal (WebGL / Three.js)")
fractal_html = '''<!DOCTYPE html>
<html>
<head>
    <style>
        body {
...
# Render the HTML via a Streamlit component (wrapped in its own iframe)
components.html(fractal_html, height=700, width=700)
